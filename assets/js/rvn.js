...
var welcomeHead = "raven-solo.com";
var server = "raven-solo.com";
var defaultPool = 'ravencoin';
...
var discord = "https://discord.gg/QyHbH3WvF2";
var telegram = "https://t.me/";
var twitter = "https://twitter.com/";
var github = "https://github.com/";
var donation = "RGMekPxjwU6pAY7SG5Gom9c6WQni3Y5jRP";
...
function loadGeneralData() {
	return $.ajax(API + "pool_dashboard").done(function (data) {
		...
		$.each(data, function (index, value) {
			...
			poolHeader += "<a href='" + mainWeb + "' target='_blank'><h4 class='d-none d-lg-flex logo-text text-white'>raven.miningcrypto.live&nbsp;</h4></a>";
			poolHeader2 += "<a href='" + mainWeb + "' target='_blank'><h4 class='d-none d-lg-flex logo-text text-white'>raven.miningcrypto.live&nbsp;</h4></a>";
...
function loadStatsChart() {
	return $.ajax(API + "pool_statshistory").done(function (data) {
		...
		$.each(data, function (index, value) {
			if (newData.length === 0) {
				newData.push(value)
			} else if (newData.length > 0 && ((value.time - newData[newData.length - 1].time)) > 1200) {
				newData.push(value);
			}
		});
